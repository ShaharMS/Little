...
void haxe_io_Bytes_setDouble(haxe__io__Bytes r0,int r1,double r2) {
	...
	r4 = r1 + r5;
	r5 = r0->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$f9d86ae_8_6;
	r6 = (venum*)g$haxe_io_Error_OutsideBounds;
	hl_throw((vdynamic*)r6);
	label$f9d86ae_8_6:
	r7 = r0->b;
...
void haxe_io_Bytes_setInt32(haxe__io__Bytes r0,int r1,int r2) {
	...
	r4 = r1 + r5;
	r5 = r0->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$f9d86ae_10_6;
	r6 = (venum*)g$haxe_io_Error_OutsideBounds;
	hl_throw((vdynamic*)r6);
	label$f9d86ae_10_6:
	r7 = r0->b;
...
String haxe_io_Bytes_getString(haxe__io__Bytes r0,int r1,int r2,venum* r3) {
	...
	int r5, r6;
	r6 = 0;
	if( r1 < r6 ) goto label$f9d86ae_11_7;
	r6 = 0;
	if( r2 < r6 ) goto label$f9d86ae_11_7;
	r5 = r1 + r2;
	r6 = r0->length;
	if( ((unsigned)r6) >= ((unsigned)r5) ) goto label$f9d86ae_11_9;
	label$f9d86ae_11_7:
	r7 = (venum*)g$haxe_io_Error_OutsideBounds;
	hl_throw((vdynamic*)r7);
	label$f9d86ae_11_9:
	...
	*(unsigned char*)(r8 + r5) = (unsigned char)r6;
	...
	if( r3 != r10 ) goto label$f9d86ae_11_29;
