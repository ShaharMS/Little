...
sys__thread___Thread__HaxeThread sys_thread__Thread_HaxeThread_current() {
	sys__thread___Thread__HaxeThread r4, r11, r13;
	...
	r10 = r9->length;
	if( r8 >= r10 ) goto label$ca28e11_1_37;
	r10 = r9->length;
	if( ((unsigned)r8) < ((unsigned)r10) ) goto label$ca28e11_1_24;
	r11 = NULL;
	goto label$ca28e11_1_30;
	label$ca28e11_1_24:
	r12 = r9->array;
	r6 = ((vdynamic**)(r12 + 1))[r8];
	r11 = (sys__thread___Thread__HaxeThread)r6;
	r13 = (sys__thread___Thread__HaxeThread)hl_dyn_castp(&r6,&t$_dyn,&t$sys_thread__Thread_HaxeThread);
	if( r11 == r13 ) goto label$ca28e11_1_30;
	hl_assert();
	label$ca28e11_1_30:
	++r8;
	if( r11 == NULL ) hl_null_access();
	r2 = r11->handle;
	if( r2 != r0 ) goto label$ca28e11_1_36;
	r4 = r11;
	goto label$ca28e11_1_37;
	label$ca28e11_1_36:
	goto label$ca28e11_1_16;
	label$ca28e11_1_37:
	if( r4 ) goto label$ca28e11_1_45;
