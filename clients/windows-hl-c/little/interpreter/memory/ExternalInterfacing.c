...
void little_interpreter_memory_ExternalInterfacing_createAllPathsFor(little__interpreter__memory__ExternalInterfacing r0,hl__types__ArrayObj r1) {
	little__interpreter__memory__ExtTree r2, r4;
	r2 = r0->globalProperties;
	r4 = little_interpreter_memory_ExternalInterfacing_createPathFor(r0,r2,r1);
	r2 = r0->instanceProperties;
	r4 = little_interpreter_memory_ExternalInterfacing_createPathFor(r0,r2,r1);
	return;
}
...
bool little_interpreter_memory_ExternalInterfacing_hasInstance(little__interpreter__memory__ExternalInterfacing r0,hl__types__ArrayObj r1) {
	...
	r4 = r2->length;
	r5 = 0;
	if( r5 >= r4 ) goto label$a57a63b_5_24;
	r6 = hl_types_ArrayObj_shift(r2);
	r7 = (String)r6;
	if( r3 == NULL ) hl_null_access();
	r9 = r3->properties;
	if( r9 == NULL ) hl_null_access();
	r8 = haxe_ds_StringMap_exists(r9,r7);
	if( !r8 ) goto label$a57a63b_5_21;
	r9 = r3->properties;
	if( r9 == NULL ) hl_null_access();
	r6 = haxe_ds_StringMap_get(r9,r7);
	r10 = (little__interpreter__memory__ExtTree)r6;
	r3 = r10;
	goto label$a57a63b_5_23;
	label$a57a63b_5_21:
	r8 = false;
	return r8;
	label$a57a63b_5_23:
	goto label$a57a63b_5_3;
	label$a57a63b_5_24:
	r8 = true;
	return r8;
}
...
vvirtual* little_interpreter_memory_ExternalInterfacing_getGlobal(little__interpreter__memory__ExternalInterfacing r0,hl__types__ArrayObj r1) {
	...
	if( r2 == NULL ) hl_null_access();
	r5 = r2->length;
	if( r4 >= r5 ) goto label$a57a63b_6_23;
	r5 = r2->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$a57a63b_6_12;
	r6 = NULL;
	goto label$a57a63b_6_15;
	label$a57a63b_6_12:
	r8 = r2->array;
	r7 = ((vdynamic**)(r8 + 1))[r4];
	r6 = (String)r7;
