...
#  include <little/tools/_TextTools/MultilangFonts.c>
...
#  include <vision/ds/ImageView.c>
#  include <vision/ds/Point2D.c>
#  include <vision/ds/Pixel.c>
#  include <vision/ds/Ray2D.c>
#  include <vision/ds/Line2D.c>
#  include <vision/ds/Rectangle.c>
#  include <vision/ds/_Image/Image_Impl_.c>
#  include <vision/exceptions/VisionException.c>
#  include <vision/exceptions/OutOfBounds.c>
#  include <vision/ds/Array2D.c>
#  include <vision/ds/_Color/Color_Impl_.c>
#  include <vision/tools/ImageTools.c>
#  include <vision/exceptions/Unimplemented.c>
#  include <vision/ds/_Image/PixelIterator.c>
#  include <vision/ds/specifics/PointTransformationPair.c>
#  include <vision/exceptions/MatrixOperationError.c>
#  include <vision/ds/Point3D.c>
#  include <vision/exceptions/ImageLoadingFailed.c>
#  include <vision/exceptions/ImageSavingFailed.c>
#  include <vision/exceptions/LibraryRequired.c>
#  include <vision/exceptions/MultithreadFailure.c>
#  include <vision/helpers/VisionThread.c>
#  include <vision/tools/_ImageTools/NeighborsIterator.c>
#  include <_std/Main.c>
...
#  include <vision/algorithms/BilinearInterpolation.c>
#  include <vision/algorithms/Cramer.c>
#  include <vision/algorithms/GaussJordan.c>
#  include <vision/algorithms/PerspectiveWarp.c>
#  include <vision/algorithms/Radix.c>
#  include <vision/ds/_ByteArray/ByteArray_Impl_.c>
#  include <vision/ds/_IntPoint2D/IntPoint2D_Impl_.c>
#  include <vision/ds/_Matrix2D/Matrix2D_Impl_.c>
#  include <vision/ds/_PixelFormat/PixelFormat_Impl_.c>
#  include <vision/ds/_TransformationMatrix2D/TransformationMatrix2D_Impl_.c>
#  include <vision/helpers/TextDrawer.c>
