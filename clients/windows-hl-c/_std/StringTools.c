...
String StringTools_hex(int r0,vdynamic* r1) {
	...
	r0 = r6;
	r7 = 0;
	if( r7 < r6 ) goto label$de37252_8_17;
	goto label$de37252_8_18;
	label$de37252_8_17:
	goto label$de37252_8_2;
	label$de37252_8_18:
	if( !r1 ) goto label$de37252_8_28;
	label$de37252_8_19:
	if( r2 == NULL ) hl_null_access();
	r6 = r2->length;
	r7 = r1 ? r1->v.i : 0;
	if( r6 >= r7 ) goto label$de37252_8_28;
	r5 = (String)s$0;
	r5 = String___add__(r5,r2);
	r2 = r5;
	goto label$de37252_8_19;
	label$de37252_8_28:
	return r2;
}
