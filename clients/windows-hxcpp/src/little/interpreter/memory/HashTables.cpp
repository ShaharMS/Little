...
HXLINE(  39)				 ::haxe::io::Bytes _this = array;
HXDLIN(  39)				if (((((( (int)(_this->b->__get(keyIndex)) ) | (( (int)(_this->b->__get((keyIndex + 1))) ) << 8)) | (( (int)(_this->b->__get((keyIndex + 2))) ) << 16)) | (( (int)(_this->b->__get((keyIndex + 3))) ) << 24)) == 0)) {
HXLINE(  40)					{
HXLINE(  40)						 ::haxe::io::Bytes _this1 = array;
HXDLIN(  40)						int v = ( (int)(pair->__Field(HX_("keyPointer",de,60,a9,bf),::hx::paccDynamic)) );
HXDLIN(  40)						_this1->b[keyIndex] = ( (unsigned char)(v) );
HXDLIN(  40)						_this1->b[(keyIndex + 1)] = ( (unsigned char)((v >> 8)) );
HXDLIN(  40)						_this1->b[(keyIndex + 2)] = ( (unsigned char)((v >> 16)) );
HXDLIN(  40)						_this1->b[(keyIndex + 3)] = ( (unsigned char)(::hx::UShr(v,24)) );
            					}
HXLINE(  41)					{
HXLINE(  41)						 ::haxe::io::Bytes _this2 = array;
HXDLIN(  41)						int pos = (keyIndex + 4);
HXDLIN(  41)						int v1 = ( (int)(pair->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXDLIN(  41)						_this2->b[pos] = ( (unsigned char)(v1) );
HXDLIN(  41)						_this2->b[(pos + 1)] = ( (unsigned char)((v1 >> 8)) );
HXDLIN(  41)						_this2->b[(pos + 2)] = ( (unsigned char)((v1 >> 16)) );
HXDLIN(  41)						_this2->b[(pos + 3)] = ( (unsigned char)(::hx::UShr(v1,24)) );
            					}
HXLINE(  42)					{
HXLINE(  42)						 ::haxe::io::Bytes _this3 = array;
HXDLIN(  42)						int pos1 = (keyIndex + 8);
HXDLIN(  42)						int v2 = ( (int)(pair->__Field(HX_("type",ba,f2,08,4d),::hx::paccDynamic)) );
HXDLIN(  42)						_this3->b[pos1] = ( (unsigned char)(v2) );
HXDLIN(  42)						_this3->b[(pos1 + 1)] = ( (unsigned char)((v2 >> 8)) );
HXDLIN(  42)						_this3->b[(pos1 + 2)] = ( (unsigned char)((v2 >> 16)) );
HXDLIN(  42)						_this3->b[(pos1 + 3)] = ( (unsigned char)(::hx::UShr(v2,24)) );
            					}
HXLINE(  43)					{
HXLINE(  43)						 ::haxe::io::Bytes _this4 = array;
HXDLIN(  43)						int pos2 = (keyIndex + 12);
HXDLIN(  43)						int v3 = ( (int)(pair->__Field(HX_("doc",78,42,4c,00),::hx::paccDynamic)) );
HXDLIN(  43)						_this4->b[pos2] = ( (unsigned char)(v3) );
HXDLIN(  43)						_this4->b[(pos2 + 1)] = ( (unsigned char)((v3 >> 8)) );
HXDLIN(  43)						_this4->b[(pos2 + 2)] = ( (unsigned char)((v3 >> 16)) );
HXDLIN(  43)						_this4->b[(pos2 + 3)] = ( (unsigned char)(::hx::UShr(v3,24)) );
            					}
            				}
            				else {
...
HXLINE(  49)						 ::haxe::io::Bytes _this5 = array;
HXDLIN(  49)						if (!(((((( (int)(_this5->b->__get(i)) ) | (( (int)(_this5->b->__get((i + 1))) ) << 8)) | (( (int)(_this5->b->__get((i + 2))) ) << 16)) | (( (int)(_this5->b->__get((i + 3))) ) << 24)) != 0))) {
...
HXLINE(  56)							HX_STACK_DO_THROW(HX_("Object hash table did not generate. This should never happen. Initial length may be incorrect.",f8,88,9a,e9));
            					...
            					_hx_goto_1:;
HXLINE(  59)					{
HXLINE(  59)						 ::haxe::io::Bytes _this6 = array;
HXDLIN(  59)						int v4 = ( (int)(pair->__Field(HX_("keyPointer",de,60,a9,bf),::hx::paccDynamic)) );
HXDLIN(  59)						_this6->b[i] = ( (unsigned char)(v4) );
HXDLIN(  59)						_this6->b[(i + 1)] = ( (unsigned char)((v4 >> 8)) );
HXDLIN(  59)						_this6->b[(i + 2)] = ( (unsigned char)((v4 >> 16)) );
HXDLIN(  59)						_this6->b[(i + 3)] = ( (unsigned char)(::hx::UShr(v4,24)) );
            					}
HXLINE(  60)					{
HXLINE(  60)						 ::haxe::io::Bytes _this7 = array;
HXDLIN(  60)						int pos3 = (i + 4);
HXDLIN(  60)						int v5 = ( (int)(pair->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXDLIN(  60)						_this7->b[pos3] = ( (unsigned char)(v5) );
HXDLIN(  60)						_this7->b[(pos3 + 1)] = ( (unsigned char)((v5 >> 8)) );
HXDLIN(  60)						_this7->b[(pos3 + 2)] = ( (unsigned char)((v5 >> 16)) );
HXDLIN(  60)						_this7->b[(pos3 + 3)] = ( (unsigned char)(::hx::UShr(v5,24)) );
            					}
HXLINE(  61)					{
HXLINE(  61)						 ::haxe::io::Bytes _this8 = array;
HXDLIN(  61)						int pos4 = (i + 8);
HXDLIN(  61)						int v6 = ( (int)(pair->__Field(HX_("type",ba,f2,08,4d),::hx::paccDynamic)) );
HXDLIN(  61)						_this8->b[pos4] = ( (unsigned char)(v6) );
HXDLIN(  61)						_this8->b[(pos4 + 1)] = ( (unsigned char)((v6 >> 8)) );
HXDLIN(  61)						_this8->b[(pos4 + 2)] = ( (unsigned char)((v6 >> 16)) );
HXDLIN(  61)						_this8->b[(pos4 + 3)] = ( (unsigned char)(::hx::UShr(v6,24)) );
            					}
HXLINE(  62)					{
HXLINE(  62)						 ::haxe::io::Bytes _this9 = array;
HXDLIN(  62)						int pos5 = (i + 12);
HXDLIN(  62)						int v7 = ( (int)(pair->__Field(HX_("doc",78,42,4c,00),::hx::paccDynamic)) );
HXDLIN(  62)						_this9->b[pos5] = ( (unsigned char)(v7) );
HXDLIN(  62)						_this9->b[(pos5 + 1)] = ( (unsigned char)((v7 >> 8)) );
HXDLIN(  62)						_this9->b[(pos5 + 2)] = ( (unsigned char)((v7 >> 16)) );
HXDLIN(  62)						_this9->b[(pos5 + 3)] = ( (unsigned char)(::hx::UShr(v7,24)) );
            					}
            				}
            			}
            		}
...
HXLINE(  81)			 ::haxe::io::Bytes _this = bytes;
HXDLIN(  81)			int keyPointer = ::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt((((( (int)(_this->b->__get(i)) ) | (( (int)(_this->b->__get((i + 1))) ) << 8)) | (( (int)(_this->b->__get((i + 2))) ) << 16)) | (( (int)(_this->b->__get((i + 3))) ) << 24)));
HXLINE(  82)			 ::haxe::io::Bytes _this1 = bytes;
HXDLIN(  82)			int pos = (i + 4);
HXDLIN(  82)			int value = ::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt((((( (int)(_this1->b->__get(pos)) ) | (( (int)(_this1->b->__get((pos + 1))) ) << 8)) | (( (int)(_this1->b->__get((pos + 2))) ) << 16)) | (( (int)(_this1->b->__get((pos + 3))) ) << 24)));
HXLINE(  83)			 ::haxe::io::Bytes _this2 = bytes;
HXDLIN(  83)			int pos1 = (i + 8);
HXDLIN(  83)			int type = ::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt((((( (int)(_this2->b->__get(pos1)) ) | (( (int)(_this2->b->__get((pos1 + 1))) ) << 8)) | (( (int)(_this2->b->__get((pos1 + 2))) ) << 16)) | (( (int)(_this2->b->__get((pos1 + 3))) ) << 24)));
HXLINE(  84)			 ::haxe::io::Bytes _this3 = bytes;
HXDLIN(  84)			int pos2 = (i + 12);
HXDLIN(  84)			int doc = ::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt((((( (int)(_this3->b->__get(pos2)) ) | (( (int)(_this3->b->__get((pos2 + 1))) ) << 8)) | (( (int)(_this3->b->__get((pos2 + 2))) ) << 16)) | (( (int)(_this3->b->__get((pos2 + 3))) ) << 24)));
...
HXLINE( 123)			 ::haxe::io::Bytes _this = hashTable;
HXDLIN( 123)			::String currentKey = storage->readString(::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt((((( (int)(_this->b->__get(keyIndex)) ) | (( (int)(_this->b->__get((keyIndex + 1))) ) << 8)) | (( (int)(_this->b->__get((keyIndex + 2))) ) << 16)) | (( (int)(_this->b->__get((keyIndex + 3))) ) << 24))));
...
HXLINE( 154)			 ::haxe::io::Bytes _this = hashTable;
HXDLIN( 154)			::String currentKey = storage->readString(::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt((((( (int)(_this->b->__get(keyIndex)) ) | (( (int)(_this->b->__get((keyIndex + 1))) ) << 8)) | (( (int)(_this->b->__get((keyIndex + 2))) ) << 16)) | (( (int)(_this->b->__get((keyIndex + 3))) ) << 24))));
HXLINE( 155)			if ((currentKey == key)) {
HXLINE( 158)				 ::haxe::io::Bytes _this1 = hashTable;
HXDLIN( 158)				int _hx_tmp = ::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt((((( (int)(_this1->b->__get(keyIndex)) ) | (( (int)(_this1->b->__get((keyIndex + 1))) ) << 8)) | (( (int)(_this1->b->__get((keyIndex + 2))) ) << 16)) | (( (int)(_this1->b->__get((keyIndex + 3))) ) << 24)));
HXLINE( 159)				 ::haxe::io::Bytes _this2 = hashTable;
HXDLIN( 159)				int pos = (keyIndex + 4);
HXDLIN( 159)				int _hx_tmp1 = ::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt((((( (int)(_this2->b->__get(pos)) ) | (( (int)(_this2->b->__get((pos + 1))) ) << 8)) | (( (int)(_this2->b->__get((pos + 2))) ) << 16)) | (( (int)(_this2->b->__get((pos + 3))) ) << 24)));
HXLINE( 160)				 ::haxe::io::Bytes _this3 = hashTable;
HXDLIN( 160)				int pos1 = (keyIndex + 8);
HXDLIN( 160)				int _hx_tmp2 = ::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt((((( (int)(_this3->b->__get(pos1)) ) | (( (int)(_this3->b->__get((pos1 + 1))) ) << 8)) | (( (int)(_this3->b->__get((pos1 + 2))) ) << 16)) | (( (int)(_this3->b->__get((pos1 + 3))) ) << 24)));
HXLINE( 161)				 ::haxe::io::Bytes _this4 = hashTable;
HXDLIN( 161)				int pos2 = (keyIndex + 12);
HXLINE( 156)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("keyPointer",de,60,a9,bf),_hx_tmp)
            					->setFixed(1,HX_("doc",78,42,4c,00),::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt((((( (int)(_this4->b->__get(pos2)) ) | (( (int)(_this4->b->__get((pos2 + 1))) ) << 8)) | (( (int)(_this4->b->__get((pos2 + 2))) ) << 16)) | (( (int)(_this4->b->__get((pos2 + 3))) ) << 24))))
            					->setFixed(2,HX_("key",9f,89,51,00),key)
...
HXLINE( 234)			 ::haxe::io::Bytes _this = hashTableBytes1;
HXDLIN( 234)			if (((((( (int)(_this->b->__get(keyIndex)) ) | (( (int)(_this->b->__get((keyIndex + 1))) ) << 8)) | (( (int)(_this->b->__get((keyIndex + 2))) ) << 16)) | (( (int)(_this->b->__get((keyIndex + 3))) ) << 24)) == 0)) {
