...
HXLINE(  64)		{
HXLINE(  64)			 ::haxe::io::Bytes _this3 = header;
HXDLIN(  64)			_this3->b[0] = ( (unsigned char)(currentScopeLength) );
HXDLIN(  64)			_this3->b[1] = ( (unsigned char)((currentScopeLength >> 8)) );
            		}
HXLINE(  65)		{
HXLINE(  65)			 ::haxe::io::Bytes _this4 = header;
HXDLIN(  65)			_this4->b[2] = ( (unsigned char)(0) );
HXDLIN(  65)			_this4->b[3] = ( (unsigned char)(0) );
            		}
...
HXLINE(  74)		{
HXLINE(  74)			 ::haxe::io::Bytes _this5 = this->bytes;
HXDLIN(  74)			_this5->b[0] = ( (unsigned char)(writePosition) );
HXDLIN(  74)			_this5->b[1] = ( (unsigned char)((writePosition >> 8)) );
HXDLIN(  74)			_this5->b[2] = ( (unsigned char)((writePosition >> 16)) );
HXDLIN(  74)			_this5->b[3] = ( (unsigned char)(::hx::UShr(writePosition,24)) );
            		}
            	}
