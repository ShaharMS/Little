...
HXLINE( 377)		 ::little::interpreter::InterpTokens val = ::little::interpreter::Interpreter_obj::evaluate(value,null());
HXLINE( 378)		::String func = ::little::Little_obj::keywords->TYPE_CAST_FUNCTION_PREFIX;
HXDLIN( 378)		 ::little::interpreter::InterpTokens func1 = ::little::interpreter::InterpTokens_obj::Identifier((func + postType->join(HX_("_",5f,00,00,00))));
HXLINE( 379)		value = ::little::interpreter::Interpreter_obj::call(::little::interpreter::InterpTokens_obj::PropertyAccess(val,func1),::little::interpreter::InterpTokens_obj::PartArray(::Array_obj< ::Dynamic>::__new(0)));
HXLINE( 380)		{
HXLINE( 380)			int _g = 0;
