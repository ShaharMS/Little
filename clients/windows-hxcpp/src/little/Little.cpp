...
HX_LOCAL_STACK_FRAME(_hx_pos_9a3daa5a3ce12a32_88_loadModule,"little.Little","loadModule",0x799ca252,"little.Little.loadModule","little/Little.hx",88,0x981f31cf)
HX_LOCAL_STACK_FRAME(_hx_pos_9a3daa5a3ce12a32_127_run,"little.Little","run",0x02558c6b,"little.Little.run","little/Little.hx",127,0x981f31cf)
HX_LOCAL_STACK_FRAME(_hx_pos_9a3daa5a3ce12a32_167_compile,"little.Little","compile",0xe6f6da93,"little.Little.compile","little/Little.hx",167,0x981f31cf)
HX_LOCAL_STACK_FRAME(_hx_pos_9a3daa5a3ce12a32_176_format,"little.Little","format",0xf3abde17,"little.Little.format","little/Little.hx",176,0x981f31cf)
HX_LOCAL_STACK_FRAME(_hx_pos_9a3daa5a3ce12a32_181_reset,"little.Little","reset",0x619276ef,"little.Little.reset","little/Little.hx",181,0x981f31cf)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9a3daa5a3ce12a32_74_boot,"little.Little","boot",0xfded5b12,"little.Little.boot","little/Little.hx",74,0x981f31cf)
namespace little{
...
void Little_obj::loadModule(::String code,::String name,::hx::Null< bool >  __o_debug,::hx::Null< bool >  __o_runRightBeforeMain){
            	...
            	HX_STACKFRAME(&_hx_pos_9a3daa5a3ce12a32_88_loadModule)
HXLINE(  89)		::little::Little_obj::runtime->errorThrown = false;
HXLINE(  90)		::little::Little_obj::runtime->line = 0;
HXLINE(  91)		::little::Little_obj::runtime->module = name;
HXLINE(  92)		if (runRightBeforeMain) {
HXLINE(  93)			::little::Little_obj::queue->enqueue(code);
            		}
            		else {
HXLINE(  95)			bool previous = ::little::Little_obj::debug;
HXLINE(  96)			::little::Little_obj::debug = debug;
HXLINE(  97)			if (!(::little::tools::PrepareRun_obj::prepared)) {
HXLINE(  98)				::little::tools::PrepareRun_obj::addTypes();
HXLINE(  99)				::little::tools::PrepareRun_obj::addSigns();
HXLINE( 100)				::little::tools::PrepareRun_obj::addFunctions();
HXLINE( 101)				::little::tools::PrepareRun_obj::addConditions();
HXLINE( 102)				::little::tools::PrepareRun_obj::addProps();
            			}
HXLINE( 104)			 ::Dynamic array = ::little::parser::Parser_obj::parse;
HXDLIN( 104)			::little::interpreter::Interpreter_obj::run(::little::interpreter::Interpreter_obj::convert(( (::Array< ::Dynamic>)(array(::little::lexer::Lexer_obj::lex(code))) )),null());
HXLINE( 105)			::little::Little_obj::debug = previous;
            		}
            	}
...
void Little_obj::run(::String code, ::Dynamic debug){
            	HX_STACKFRAME(&_hx_pos_9a3daa5a3ce12a32_127_run)
HXDLIN( 127)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 128)			bool previous = ::little::Little_obj::debug;
HXLINE( 129)			if (::hx::IsNotNull( debug )) {
HXLINE( 129)				::little::Little_obj::debug = ( (bool)(debug) );
            			}
HXLINE( 130)			if (!(::little::tools::PrepareRun_obj::prepared)) {
HXLINE( 131)				::little::tools::PrepareRun_obj::addTypes();
HXLINE( 132)				::little::tools::PrepareRun_obj::addSigns();
HXLINE( 133)				::little::tools::PrepareRun_obj::addFunctions();
HXLINE( 134)				::little::tools::PrepareRun_obj::addConditions();
HXLINE( 135)				::little::tools::PrepareRun_obj::addProps();
            			}
HXLINE( 137)			::little::Little_obj::runtime->module = ::little::Little_obj::keywords->MAIN_MODULE_NAME;
HXLINE( 138)			::little::Little_obj::runtime->errorThrown = false;
HXLINE( 139)			::little::Little_obj::runtime->line = 0;
HXLINE( 140)			::little::Little_obj::queue->enqueue(code);
HXLINE( 141)			{
HXLINE( 141)				 ::Dynamic item = ::little::Little_obj::queue->iterator();
HXDLIN( 141)				while(( (bool)(item->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 141)					::String item1 = ( (::String)(item->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 142)					 ::Dynamic array = ::little::parser::Parser_obj::parse;
HXDLIN( 142)					::little::interpreter::Interpreter_obj::run(::little::interpreter::Interpreter_obj::convert(( (::Array< ::Dynamic>)(array(::little::lexer::Lexer_obj::lex(item1))) )),null());
            				}
            			}
HXLINE( 144)			if (::hx::IsNotNull( debug )) {
HXLINE( 144)				::little::Little_obj::debug = previous;
            			}
            		} catch( ::Dynamic _hx_e) {
...
::Array< ::Dynamic> Little_obj::compile(::String code){
            	HX_STACKFRAME(&_hx_pos_9a3daa5a3ce12a32_167_compile)
HXDLIN( 167)		 ::Dynamic array = ::little::parser::Parser_obj::parse;
HXDLIN( 167)		return ::little::interpreter::Interpreter_obj::convert(( (::Array< ::Dynamic>)(array(::little::lexer::Lexer_obj::lex(code))) ));
            	}
...
::String Little_obj::format(::String code){
            	HX_STACKFRAME(&_hx_pos_9a3daa5a3ce12a32_176_format)
HXDLIN( 176)		 ::Dynamic _hx_tmp = ::little::parser::Parser_obj::parse;
HXDLIN( 176)		return ::little::tools::PrettyPrinter_obj::stringifyParser(( (::Array< ::Dynamic>)(_hx_tmp(::little::lexer::Lexer_obj::lex(code))) ),null());
            	}
...
void Little_obj::reset(){
            	HX_GC_STACKFRAME(&_hx_pos_9a3daa5a3ce12a32_181_reset)
HXLINE( 182)		::little::Little_obj::runtime =  ::little::interpreter::Runtime_obj::__alloc( HX_CTX );
HXLINE( 183)		::little::Little_obj::memory->reset();
HXLINE( 184)		::little::Little_obj::queue =  ::vision::ds::Queue_String_obj::__alloc( HX_CTX );
            	}
...
{
            	HX_STACKFRAME(&_hx_pos_9a3daa5a3ce12a32_74_boot)
HXDLIN(  74)		version = HX_("1.0.0-f",8e,90,ce,1b);
            	}
}
