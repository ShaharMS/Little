...
HXLINE(  26)						 ::vision::ds::Array2D _this = augmentedMatrix1;
HXDLIN(  26)						 ::vision::ds::Array2D _this1 = augmentedMatrix1;
HXDLIN(  26)						if ((::Math_obj::abs(( (Float)(_this->inner->__get(((i * _this->width) + j))) )) > ::Math_obj::abs(( (Float)(_this1->inner->__get(((i * _this1->width) + pivotRow))) )))) {
HXLINE(  27)							pivotRow = j;
            						}
            					}
            				}
HXLINE(  32)				 ::vision::ds::Array2D _this2 = augmentedMatrix1;
HXDLIN(  32)				if ((::Math_obj::abs(( (Float)(_this2->inner->__get(((i * _this2->width) + pivotRow))) )) < ((Float)1e-12))) {
...
HXLINE(  42)				 ::vision::ds::Array2D _this3 = augmentedMatrix1;
HXDLIN(  42)				Float pivot = ( (Float)(_this3->inner->__get(((i * _this3->width) + i))) );
HXLINE(  43)				{
HXLINE(  43)					int _g4 = 0;
...
HXLINE(  44)						{
HXLINE(  44)							 ::vision::ds::Array2D _this4 = augmentedMatrix1;
HXDLIN(  44)							_this4->inner->set((i + (j1 * _this4->width)),pivot);
            						}
            					}
            				}
HXLINE(  48)				{
...
HXLINE(  49)						if ((j2 != i)) {
HXLINE(  50)							 ::vision::ds::Array2D _this5 = augmentedMatrix1;
HXDLIN(  50)							Float factor = ( (Float)(_this5->inner->__get(((i * _this5->width) + j2))) );
HXLINE(  51)							{
HXLINE(  51)								int _g8 = 0;
...
HXLINE(  52)									{
HXLINE(  52)										 ::vision::ds::Array2D _this6 = augmentedMatrix1;
HXDLIN(  52)										 ::vision::ds::Array2D _this7 = augmentedMatrix1;
HXDLIN(  52)										_this6->inner->set((j2 + (k * _this6->width)),(factor * ( (Float)(_this7->inner->__get(((k * _this7->width) + i))) )));
            									}
            								}
            							}
            						}
...
HXLINE( 105)						 ::vision::ds::Array2D _this = matrix;
HXDLIN( 105)						extractedMatrix->__get(i).StaticCast< ::Array< Float > >()->push(_this->inner->__get(((j * _this->width) + i)));
            					}
            				}
            			}
            		}
