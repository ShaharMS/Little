...
HXLINE(  43)			{
HXLINE(  44)				{
HXLINE(  44)					 ::vision::ds::Array2D _this = M;
HXDLIN(  44)					_this->inner->set((0 * _this->width),x->__get(0));
            				}
HXLINE(  45)				{
HXLINE(  45)					 ::vision::ds::Array2D _this1 = M;
HXDLIN(  45)					_this1->inner->set((1 + (0 * _this1->width)),x->__get(1));
            				}
HXLINE(  46)				{
HXLINE(  46)					 ::vision::ds::Array2D _this2 = M;
HXDLIN(  46)					_this2->inner->set((2 + (0 * _this2->width)),x->__get(2));
            				}
            			}
HXLINE(  43)			{
HXLINE(  44)				{
HXLINE(  44)					 ::vision::ds::Array2D _this3 = M;
HXDLIN(  44)					_this3->inner->set(_this3->width,x->__get(3));
            				}
HXLINE(  45)				{
HXLINE(  45)					 ::vision::ds::Array2D _this4 = M;
HXDLIN(  45)					_this4->inner->set((1 + _this4->width),x->__get(4));
            				}
HXLINE(  46)				{
HXLINE(  46)					 ::vision::ds::Array2D _this5 = M;
HXDLIN(  46)					_this5->inner->set((2 + _this5->width),x->__get(5));
            				}
            			}
HXLINE(  43)			{
HXLINE(  44)				{
HXLINE(  44)					 ::vision::ds::Array2D _this6 = M;
HXDLIN(  44)					_this6->inner->set((2 * _this6->width),x->__get(6));
            				}
HXLINE(  45)				{
HXLINE(  45)					 ::vision::ds::Array2D _this7 = M;
HXDLIN(  45)					_this7->inner->set((1 + (2 * _this7->width)),x->__get(7));
            				}
HXLINE(  46)				{
HXLINE(  46)					 ::vision::ds::Array2D _this8 = M;
HXDLIN(  46)					_this8->inner->set((2 + (2 * _this8->width)),x->__get(8));
            				}
            			}
            		}
HXLINE(  49)		return M;
