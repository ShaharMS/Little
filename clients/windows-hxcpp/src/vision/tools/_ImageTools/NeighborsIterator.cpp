...
HXDLIN( 593)		int ma = ((( (int)(this1->b->__get(0)) ) | (( (int)(this1->b->__get(1)) ) << 8)) - 1);
...
HXDLIN( 593)		int ma1 = (::Math_obj::ceil((( (Float)((this1->length - ::vision::ds::_Image::Image_Impl__obj::OFFSET)) ) / ( (Float)(((( (int)(this1->b->__get(0)) ) | (( (int)(this1->b->__get(1)) ) << 8)) * 4)) ))) - 1);
...
HXLINE( 593)			_hx_tmp4 = (x1 < (( (int)(this1->b->__get(0)) ) | (( (int)(this1->b->__get(1)) ) << 8)));
            		}
            		else {
HXLINE( 593)			_hx_tmp4 = false;
            		}
HXDLIN( 593)		if (_hx_tmp4) {
HXLINE( 593)			_hx_tmp3 = (y2 < ::Math_obj::ceil((( (Float)((this1->length - ::vision::ds::_Image::Image_Impl__obj::OFFSET)) ) / ( (Float)(((( (int)(this1->b->__get(0)) ) | (( (int)(this1->b->__get(1)) ) << 8)) * 4)) ))));
            		}
            		else {
...
HXDLIN( 593)		int position = (((y2 * (( (int)(this1->b->__get(0)) ) | (( (int)(this1->b->__get(1)) ) << 8))) + x1) * 4);
