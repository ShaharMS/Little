...
HX_DEFINE_STACK_FRAME(_hx_pos_28409f2a982e6d01_1665_new,"vision.ds._Image.PixelIterator","new",0xea2a702d,"vision.ds._Image.PixelIterator.new","vision/ds/Image.hx",1665,0x0a62203c)
HX_LOCAL_STACK_FRAME(_hx_pos_28409f2a982e6d01_1673_next,"vision.ds._Image.PixelIterator","next",0xfaf7b886,"vision.ds._Image.PixelIterator.next","vision/ds/Image.hx",1673,0x0a62203c)
HX_LOCAL_STACK_FRAME(_hx_pos_28409f2a982e6d01_1682_hasNext,"vision.ds._Image.PixelIterator","hasNext",0x647dafba,"vision.ds._Image.PixelIterator.hasNext","vision/ds/Image.hx",1682,0x0a62203c)
namespace vision{
namespace ds{
namespace _Image{

void PixelIterator_obj::__construct( ::haxe::io::Bytes img){
            	HX_STACKFRAME(&_hx_pos_28409f2a982e6d01_1665_new)
HXLINE(1666)		this->i = 4;
HXLINE(1670)		this->img = img;
            	}
...
bool PixelIterator_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::vision::ds::Pixel PixelIterator_obj::next(){
            	HX_GC_STACKFRAME(&_hx_pos_28409f2a982e6d01_1673_next)
HXLINE(1674)		 ::haxe::io::Bytes _this = this->img;
HXDLIN(1674)		int x = ::hx::Mod(this->i,(( (int)(_this->b->__get(0)) ) | (( (int)(_this->b->__get(1)) ) << 8)));
HXLINE(1675)		 ::haxe::io::Bytes _this1 = this->img;
HXDLIN(1675)		int y = ::Math_obj::floor((( (Float)(this->i) ) / ( (Float)((( (int)(_this1->b->__get(0)) ) | (( (int)(_this1->b->__get(1)) ) << 8))) )));
HXLINE(1676)		 ::haxe::io::Bytes this1 = this->img;
HXDLIN(1676)		bool pixel;
HXDLIN(1676)		bool pixel1;
HXDLIN(1676)		bool pixel2;
HXDLIN(1676)		if ((x >= 0)) {
HXLINE(1676)			pixel2 = (y >= 0);
            		}
            		else {
HXLINE(1676)			pixel2 = false;
            		}
HXDLIN(1676)		if (pixel2) {
HXLINE(1676)			 ::haxe::io::Bytes _this2 = this1;
HXDLIN(1676)			pixel1 = (x < (( (int)(_this2->b->__get(0)) ) | (( (int)(_this2->b->__get(1)) ) << 8)));
            		}
            		else {
HXLINE(1676)			pixel1 = false;
            		}
HXDLIN(1676)		if (pixel1) {
HXLINE(1676)			 ::haxe::io::Bytes _this3 = this1;
HXDLIN(1676)			pixel = (y < ::Math_obj::ceil((( (Float)((this1->length - ::vision::ds::_Image::Image_Impl__obj::OFFSET)) ) / ( (Float)(((( (int)(_this3->b->__get(0)) ) | (( (int)(_this3->b->__get(1)) ) << 8)) * 4)) ))));
            		}
            		else {
HXLINE(1676)			pixel = false;
            		}
HXDLIN(1676)		if (!(pixel)) {
HXLINE(1676)			::cpp::Int64 this2 = _hx_int64_make(x,y);
HXDLIN(1676)			int pixel3 = _hx_int64_high(this2);
HXDLIN(1676)			HX_STACK_DO_THROW( ::vision::exceptions::OutOfBounds_obj::__alloc( HX_CTX ,this1, ::vision::ds::Point2D_obj::__alloc( HX_CTX ,pixel3,_hx_int64_low(this2))));
            		}
HXDLIN(1676)		 ::haxe::io::Bytes _this4 = this1;
HXDLIN(1676)		int position = (((y * (( (int)(_this4->b->__get(0)) ) | (( (int)(_this4->b->__get(1)) ) << 8))) + x) * 4);
HXDLIN(1676)		position = (position + ::vision::ds::_Image::Image_Impl__obj::OFFSET);
HXDLIN(1676)		 ::vision::ds::Pixel pixel4 =  ::vision::ds::Pixel_obj::__alloc( HX_CTX ,x,y,((((( (int)(this1->b->__get(position)) ) << 24) | (( (int)(this1->b->__get((position + 1))) ) << 16)) | (( (int)(this1->b->__get((position + 2))) ) << 8)) | ( (int)(this1->b->__get((position + 3))) )));
HXLINE(1677)		 ::vision::ds::_Image::PixelIterator _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1677)		_hx_tmp->i = (_hx_tmp->i + 4);
HXLINE(1678)		return pixel4;
            	}
...
bool PixelIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_28409f2a982e6d01_1682_hasNext)
HXDLIN(1682)		return (this->i < this->img->length);
            	}
