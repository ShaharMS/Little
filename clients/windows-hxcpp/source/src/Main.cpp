...
HXDLIN(  84)							 ::Dynamic array = ::little::parser::Parser_obj::parse;
HXDLIN(  84)							::String _hx_tmp1 = ::little::tools::PrettyPrinter_obj::printInterpreterAst(::little::interpreter::Interpreter_obj::convert(( (::Array< ::Dynamic>)(array(::little::lexer::Lexer_obj::lex(code))) )),null());
HXDLIN(  84)							_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("src/Main.hx",9a,7a,30,a1),84,HX_("Main",59,64,2f,33),HX_("main",39,38,56,48)));
HXLINE(  85)							::haxe::Log_obj::trace(::little::Little_obj::runtime->_hx_stdout->output,::hx::SourceInfo(HX_("src/Main.hx",9a,7a,30,a1),85,HX_("Main",59,64,2f,33),HX_("main",39,38,56,48)));
...
HXLINE( 112)						::String _hx_tmp2;
HXDLIN( 112)						if ((preDefInput == HX_("ast!",9f,5a,75,40))) {
HXLINE( 112)							_hx_tmp2 = HX_("",00,00,00,00);
            						}
            						else {
HXLINE( 112)							_hx_tmp2 = HX_("\n",0a,00,00,00);
            						}
HXDLIN( 112)						::Sys_obj::println(((HX_("",00,00,00,00) + _hx_tmp2) + HX_("---------ABSTRACT SYNTAX TREE MODE---------\n",16,2e,48,b2)));
...
HXLINE( 125)							try {
            								HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 126)								 ::Dynamic array1 = ::little::parser::Parser_obj::parse;
HXDLIN( 126)								::Sys_obj::println(::little::tools::PrettyPrinter_obj::printInterpreterAst(::little::interpreter::Interpreter_obj::convert(( (::Array< ::Dynamic>)(array1(::little::lexer::Lexer_obj::lex(input2))) )),null()));
            							} catch( ::Dynamic _hx_e) {
...
HXLINE( 129)						if ((input == HX_("printSample!",0a,a4,08,e5))) {
HXLINE( 130)							::Sys_obj::println(HX_("\n---------------SAMPLE CODE-----------------\n",3d,0c,4e,83));
HXLINE( 131)							::Sys_obj::println(::haxe::Resource_obj::getString(HX_("sample",2a,60,4a,1d)));
HXLINE( 132)							::Sys_obj::println(HX_("\n-------------SINGLE-LINE MODE--------------\n",9d,d1,62,d4));
            						}
            						else {
HXLINE( 134)							::little::Little_obj::run(input,true);
HXLINE( 136)							::haxe::Log_obj::trace(::little::Little_obj::runtime->_hx_stdout->output,::hx::SourceInfo(HX_("src/Main.hx",9a,7a,30,a1),136,HX_("Main",59,64,2f,33),HX_("main",39,38,56,48)));
HXLINE( 137)							::little::Little_obj::reset();
            						}
            					}
            				}
HXLINE( 139)				preDefInput = null();
            			}
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g1 = _hx_e;
HXLINE( 143)				::Sys_obj::println(HX_("\n\nExiting...",ca,5a,95,32));
HXLINE( 144)				::Sys_obj::exit(0);
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
            			}
