...
HXDLIN(   9)			super::__construct(((((_hx_tmp + (( (int)(image->b->__get(0)) ) | (( (int)(image->b->__get(1)) ) << 8))) + HX_("x",78,00,00,00)) + ::Math_obj::ceil((( (Float)((image->length - ::vision::ds::_Image::Image_Impl__obj::OFFSET)) ) / ( (Float)(((( (int)(image->b->__get(0)) ) | (( (int)(image->b->__get(1)) ) << 8)) * 4)) )))) + HX_(")",29,00,00,00)),HX_("Pixel Coordinates Out Of Bounds",ed,15,a4,9c));
            		}
HXDLIN(   9)		{
