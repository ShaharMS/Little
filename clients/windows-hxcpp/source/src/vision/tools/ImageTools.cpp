...
HXDLIN( 287)				int ma = ((( (int)(this1->b->__get(0)) ) | (( (int)(this1->b->__get(1)) ) << 8)) - 1);
...
HXDLIN( 287)				int ma1 = (::Math_obj::ceil((( (Float)((this1->length - ::vision::ds::_Image::Image_Impl__obj::OFFSET)) ) / ( (Float)(((( (int)(this1->b->__get(0)) ) | (( (int)(this1->b->__get(1)) ) << 8)) * 4)) ))) - 1);
...
HXLINE( 287)					_hx_tmp3 = (x2 < (( (int)(this1->b->__get(0)) ) | (( (int)(this1->b->__get(1)) ) << 8)));
            				}
            				else {
HXLINE( 287)					_hx_tmp3 = false;
            				}
HXDLIN( 287)				if (_hx_tmp3) {
HXLINE( 287)					_hx_tmp2 = (y3 < ::Math_obj::ceil((( (Float)((this1->length - ::vision::ds::_Image::Image_Impl__obj::OFFSET)) ) / ( (Float)(((( (int)(this1->b->__get(0)) ) | (( (int)(this1->b->__get(1)) ) << 8)) * 4)) ))));
            				}
            				else {
...
HXDLIN( 287)				int position = (((y3 * (( (int)(this1->b->__get(0)) ) | (( (int)(this1->b->__get(1)) ) << 8))) + x2) * 4);
