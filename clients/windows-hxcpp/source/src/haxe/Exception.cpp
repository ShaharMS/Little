...
HXDLIN(  57)					::Array< ::Dynamic> tmp1 = e->get_stack();
HXDLIN(  57)					::String result2;
HXDLIN(  57)					if (::hx::IsNull( tmp1 )) {
HXDLIN(  57)						result2 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXDLIN(  57)						result2 = ::haxe::_CallStack::CallStack_Impl__obj::toString(tmp1);
            					}
...
HXDLIN(  57)					::String result3 = (HX_("Exception: ",95,cc,ac,54) + e->get_message());
HXDLIN(  57)					::String result4;
HXDLIN(  57)					if (::hx::IsNull( prevStack1 )) {
HXDLIN(  57)						result4 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXDLIN(  57)						result4 = ::haxe::_CallStack::CallStack_Impl__obj::toString(prevStack1);
            					}
HXDLIN(  57)					result = (((result3 + result4) + HX_("\n\nNext ",ed,7e,c7,cb)) + result);
            				}
HXDLIN(  57)				prev = e;
