...
HXLINE(  30)		this->ERROR = ::little::interpreter::memory::_MemoryPointer::MemoryPointer_Impl__obj::fromInt(17);
...
void ConstantPool_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("ERROR",a8,03,18,f1));
...
static ::hx::StorageInfo ConstantPool_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(ConstantPool_obj,ERROR),HX_("ERROR",a8,03,18,f1)},
