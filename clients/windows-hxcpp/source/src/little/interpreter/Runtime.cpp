...
HX_LOCAL_STACK_FRAME(_hx_pos_bead45cc78a77e6d_216_warn,"little.interpreter.Runtime","warn",0x1a652368,"little.interpreter.Runtime.warn","little/interpreter/Runtime.hx",216,0x90ac63b4)
HX_LOCAL_STACK_FRAME(_hx_pos_bead45cc78a77e6d_235_print,"little.interpreter.Runtime","print",0x018194cb,"little.interpreter.Runtime.print","little/interpreter/Runtime.hx",235,0x90ac63b4)
HX_LOCAL_STACK_FRAME(_hx_pos_bead45cc78a77e6d_244___default_broadcast,"little.interpreter.Runtime","__default_broadcast",0x7590d0c1,"little.interpreter.Runtime.__default_broadcast","little/interpreter/Runtime.hx",244,0x90ac63b4)
HX_LOCAL_STACK_FRAME(_hx_pos_bead45cc78a77e6d_252___default__hx___broadcast,"little.interpreter.Runtime","__default__hx___broadcast",0x45049351,"little.interpreter.Runtime.__default__hx___broadcast","little/interpreter/Runtime.hx",252,0x90ac63b4)
HX_LOCAL_STACK_FRAME(_hx_pos_bead45cc78a77e6d_259___print,"little.interpreter.Runtime","__print",0x435ed12b,"little.interpreter.Runtime.__print","little/interpreter/Runtime.hx",259,0x90ac63b4)
namespace little{
...
HXLINE( 188)		::String mod = this->module;
HXLINE( 191)		::String reason = ::Std_obj::string(token);
HXLINE( 188)		::String reason1 = ::little::tools::TextTools_obj::replaceLast(::little::tools::TextTools_obj::remove(reason,::Type_obj::enumConstructor(token)).substring(1,null()),HX_(")",29,00,00,00),HX_("",00,00,00,00));
HXLINE( 192)		::String content;
HXDLIN( 192)		if (::little::Little_obj::debug) {
HXLINE( 192)			content = (layer.toUpperCase() + HX_(": ",a6,32,00,00));
            		}
            		else {
HXLINE( 192)			content = HX_("",00,00,00,00);
            		}
HXLINE( 189)		::String content1 = (((((((HX_("",00,00,00,00) + content) + HX_("ERROR: Module ",46,5f,7a,f2)) + this->module) + HX_(", Line ",98,42,4b,f9)) + this->line) + HX_(":  ",ba,1e,2c,00)) + reason1);
HXLINE( 195)		 ::little::interpreter::StdOut fh = this->_hx_stdout;
HXDLIN( 195)		fh->output = (fh->output + ((HX_("\n",0a,00,00,00) + content1) + HX_("\n",0a,00,00,00)));
HXLINE( 196)		 ::little::interpreter::StdOut fh1 = this->_hx_stdout;
HXDLIN( 196)		::String fh2 = fh1->output;
HXDLIN( 196)		::Array< ::Dynamic> _this = this->callStack;
...
HXDLIN( 196)				{
HXLINE( 196)					 ::Dynamic obj = _hx_array_unsafe_get(_this,i);
HXDLIN( 196)					::String inValue = ( (::String)(((((((HX_("\tCalled from Module ",18,40,0b,68) + obj->__Field(HX_("module",ac,34,d3,c0),::hx::paccDynamic)) + HX_(", Line ",98,42,4b,f9)) + obj->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) + HX_(" (part ",c5,d7,4a,ee)) + obj->__Field(HX_("linePart",07,32,7b,87),::hx::paccDynamic)) + HX_("): ",0f,4f,1f,00))) );
HXDLIN( 196)					::String inValue1 = (inValue + ::little::tools::PrettyPrinter_obj::stringifyInterpreter(null(),obj->__Field(HX_("token",f9,82,2b,14),::hx::paccDynamic)));
HXDLIN( 196)					result->__unsafe_set(i,inValue1);
            				}
            			}
            		}
HXDLIN( 196)		fh1->output = (fh2 + result->join(HX_("\n",0a,00,00,00)));
HXLINE( 197)		this->_hx_stdout->stdoutTokens->push(token);
HXLINE( 199)		this->callStack->push( ::Dynamic(::hx::Anon_obj::Create(4)
...
HXLINE( 201)		this->exitCode = ::little::tools::_Layer::Layer_Impl__obj::getIndexOf(layer);
HXLINE( 202)		this->errorToken = token;
HXLINE( 203)		this->errorThrown = true;
HXLINE( 204)		{
HXLINE( 204)			int _g2 = 0;
HXDLIN( 204)			::Array< ::Dynamic> _g3 = this->onErrorThrown;
HXDLIN( 204)			while((_g2 < _g3->length)){
HXLINE( 204)				 ::Dynamic func = _g3->__get(_g2);
HXDLIN( 204)				_g2 = (_g2 + 1);
HXDLIN( 204)				func(mod,this->line,reason1);
            			}
            		}
HXLINE( 206)		HX_STACK_DO_THROW(token);
...
void Runtime_obj::warn( ::little::interpreter::InterpTokens token,::String __o_layer){
            		::String layer = __o_layer;
            		if (::hx::IsNull(__o_layer)) layer = HX_("Interpreter",9a,09,07,b9);
            	HX_STACKFRAME(&_hx_pos_bead45cc78a77e6d_216_warn)
HXLINE( 217)		this->callStack->push( ::Dynamic(::hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("linePart",07,32,7b,87),this->linePart)
            			->setFixed(1,HX_("module",ac,34,d3,c0),this->module)
            			->setFixed(2,HX_("token",f9,82,2b,14),token)
            			->setFixed(3,HX_("line",f4,17,b3,47),this->line)));
HXLINE( 222)		::String reason = ::Std_obj::string(token);
HXLINE( 219)		::String reason1 = ::little::tools::TextTools_obj::replaceLast(::little::tools::TextTools_obj::remove(reason,::Type_obj::enumConstructor(token)).substring(1,null()),HX_(")",29,00,00,00),HX_("",00,00,00,00));
HXLINE( 223)		::String content;
HXDLIN( 223)		if (::little::Little_obj::debug) {
HXLINE( 223)			content = (layer.toUpperCase() + HX_(": ",a6,32,00,00));
            		}
            		else {
HXLINE( 223)			content = HX_("",00,00,00,00);
            		}
HXLINE( 220)		::String content1 = (((((((HX_("",00,00,00,00) + content) + HX_("WARNING: Module ",32,c2,ba,2f)) + this->module) + HX_(", Line ",98,42,4b,f9)) + this->line) + HX_(":  ",ba,1e,2c,00)) + reason1);
HXLINE( 226)		 ::little::interpreter::StdOut fh = this->_hx_stdout;
HXDLIN( 226)		fh->output = (fh->output + (HX_("\n",0a,00,00,00) + content1));
HXLINE( 227)		this->_hx_stdout->stdoutTokens->push(token);
HXLINE( 228)		{
HXLINE( 228)			int _g = 0;
HXDLIN( 228)			::Array< ::Dynamic> _g1 = this->onWarningPrinted;
HXDLIN( 228)			while((_g < _g1->length)){
HXLINE( 228)				 ::Dynamic func = _g1->__get(_g);
HXDLIN( 228)				_g = (_g + 1);
HXDLIN( 228)				func(this->module,this->line,reason1);
            			}
            		}
            	}
...
void Runtime_obj::print(::String item){
            	HX_STACKFRAME(&_hx_pos_bead45cc78a77e6d_235_print)
HXLINE( 236)		 ::little::interpreter::StdOut fh = this->_hx_stdout;
HXDLIN( 236)		::String fh1 = fh->output;
HXDLIN( 236)		::String _hx_tmp;
HXDLIN( 236)		if (::little::Little_obj::debug) {
HXLINE( 236)			_hx_tmp = (HX_("Interpreter",9a,09,07,b9).toUpperCase() + HX_(": ",a6,32,00,00));
            		}
            		else {
HXLINE( 236)			_hx_tmp = HX_("",00,00,00,00);
            		}
HXDLIN( 236)		fh->output = (fh1 + (((((((HX_("\n",0a,00,00,00) + _hx_tmp) + HX_("Module ",d4,09,4c,c5)) + this->module) + HX_(", Line ",98,42,4b,f9)) + this->line) + HX_(":  ",ba,1e,2c,00)) + item));
HXLINE( 237)		this->_hx_stdout->stdoutTokens->push(::little::interpreter::InterpTokens_obj::Characters(item));
            	}
...
void _hx_run(::String item){
            	HX_STACKFRAME(&_hx_pos_bead45cc78a77e6d_244___default_broadcast)
HXLINE( 245)		 ::little::interpreter::StdOut fh = ( ( ::little::interpreter::Runtime)(__this) )->_hx_stdout;
HXDLIN( 245)		::String _hx_tmp;
HXDLIN( 245)		if (::little::Little_obj::debug) {
HXLINE( 245)			_hx_tmp = HX_("BROADCAST: ",c7,7f,45,e9);
            		}
            		else {
HXLINE( 245)			_hx_tmp = HX_("",00,00,00,00);
            		}
HXDLIN( 245)		fh->output = (fh->output + ((HX_("\n",0a,00,00,00) + _hx_tmp) + item));
HXLINE( 246)		( ( ::little::interpreter::Runtime)(__this) )->_hx_stdout->stdoutTokens->push(::little::interpreter::InterpTokens_obj::Characters(item));
            	}
...
void _hx_run(::String item){
            	HX_STACKFRAME(&_hx_pos_bead45cc78a77e6d_252___default__hx___broadcast)
HXLINE( 253)		 ::little::interpreter::StdOut fh = ( ( ::little::interpreter::Runtime)(__this) )->_hx_stdout;
HXDLIN( 253)		::String _hx_tmp;
HXDLIN( 253)		if (::little::Little_obj::debug) {
HXLINE( 253)			_hx_tmp = HX_("BROADCAST: ",c7,7f,45,e9);
            		}
            		else {
HXLINE( 253)			_hx_tmp = HX_("",00,00,00,00);
            		}
HXDLIN( 253)		fh->output = (fh->output + ((HX_("\n",0a,00,00,00) + _hx_tmp) + item));
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC

void Runtime_obj::_hx___print(::String item, ::little::interpreter::InterpTokens representativeToken){
            	HX_STACKFRAME(&_hx_pos_bead45cc78a77e6d_259___print)
HXLINE( 260)		 ::little::interpreter::StdOut fh = this->_hx_stdout;
HXDLIN( 260)		::String fh1 = fh->output;
HXDLIN( 260)		::String _hx_tmp;
HXDLIN( 260)		if (::little::Little_obj::debug) {
HXLINE( 260)			_hx_tmp = (HX_("Interpreter",9a,09,07,b9).toUpperCase() + HX_(": ",a6,32,00,00));
            		}
            		else {
HXLINE( 260)			_hx_tmp = HX_("",00,00,00,00);
            		}
HXDLIN( 260)		fh->output = (fh1 + (((((((HX_("\n",0a,00,00,00) + _hx_tmp) + HX_("Module ",d4,09,4c,c5)) + this->module) + HX_(", Line ",98,42,4b,f9)) + this->line) + HX_(":  ",ba,1e,2c,00)) + item));
HXLINE( 261)		this->_hx_stdout->stdoutTokens->push(representativeToken);
            	}
