...
class HXCPP_CLASS_ATTRIBUTES Color_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		static int CERULEAN;
		static int PERIWINKLE;
		static int VERMILION;
		static int MAUVE;
		static int AZURE;
		static int TANGERINE;
		static int INDIGO;
		static int MARIGOLD;
		static int COBALT;
		static int LAVENDER;
		...
		static int IVORY;
		static int MULBERRY;
		static int SANDALWOOD;
		static int GARNET;
		static int PEWTER;
		static int CARNATION;
		static int CITRINE;
		static int CELADON;
		static int HELIOTROPE;
		static int PUCE;
		static int CINNABAR;
		static int VIRIDIAN;
		static int ECRU;
		static int ALABASTER;
		static int SAPPHIRE;
		static int PEARL;
		static int SALMON;
		static int UMBER;
