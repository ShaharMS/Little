...
HXDLIN( 411)		return ::vision::ds::_TransformationMatrix2D::TransformationMatrix2D_Impl__obj::fromMatrix2D(arr);
            	}
...
HXDLIN( 426)		return ::vision::ds::_TransformationMatrix2D::TransformationMatrix2D_Impl__obj::fromMatrix2D(arr);
            	}
...
HXDLIN( 441)		return ::vision::ds::_TransformationMatrix2D::TransformationMatrix2D_Impl__obj::fromMatrix2D(arr);
            	}
...
HXDLIN( 455)		return ::vision::ds::_TransformationMatrix2D::TransformationMatrix2D_Impl__obj::fromMatrix2D(arr);
            	}
...
HXDLIN( 470)		return ::vision::ds::_TransformationMatrix2D::TransformationMatrix2D_Impl__obj::fromMatrix2D(arr);
            	}
...
HXDLIN( 485)		return ::vision::ds::_TransformationMatrix2D::TransformationMatrix2D_Impl__obj::fromMatrix2D(arr);
            	}
...
HXLINE( 504)		return ::vision::ds::_TransformationMatrix2D::TransformationMatrix2D_Impl__obj::fromMatrix2D(::vision::algorithms::PerspectiveWarp_obj::generateMatrix(src,dst));
            	}
...
HXLINE( 577)								 ::vision::ds::Array2D _this = a;
HXDLIN( 577)								 ::vision::ds::Array2D _this1 = b;
HXDLIN( 577)								sum = (sum + (( (Float)(_this->inner->__get(((y * _this->width) + k))) ) * ( (Float)(_this1->inner->__get(((k * _this1->width) + x))) )));
            							}
            						}
HXLINE( 579)						{
HXLINE( 579)							 ::vision::ds::Array2D _this2 = result;
HXDLIN( 579)							_this2->inner->set((x + (y * _this2->width)),sum);
            						}
            					}
            				}
            			}
...
HXLINE( 594)						{
HXLINE( 594)							 ::vision::ds::Array2D _this = result;
HXDLIN( 594)							 ::vision::ds::Array2D _this1 = a;
HXDLIN( 594)							 ::vision::ds::Array2D _this2 = b;
HXDLIN( 594)							_this->inner->set((x + (y * _this->width)),(_this1->inner->__get(((y * _this1->width) + x)) + _this2->inner->__get(((y * _this2->width) + x))));
            						}
            					}
            				}
            			}
...
HXLINE( 609)						{
HXLINE( 609)							 ::vision::ds::Array2D _this = result;
HXDLIN( 609)							 ::vision::ds::Array2D _this1 = a;
HXDLIN( 609)							 ::vision::ds::Array2D _this2 = b;
HXDLIN( 609)							_this->inner->set((x + (y * _this->width)),(( (Float)(_this1->inner->__get(((y * _this1->width) + x))) ) - ( (Float)(_this2->inner->__get(((y * _this2->width) + x))) )));
            						}
            					}
            				}
            			}
...
HXLINE( 626)								 ::vision::ds::Array2D _this = a;
HXDLIN( 626)								 ::vision::ds::Array2D _this1 = b;
HXDLIN( 626)								sum = (sum + (( (Float)(_this->inner->__get(((y * _this->width) + k))) ) / ( (Float)(_this1->inner->__get(((k * _this1->width) + x))) )));
            							}
            						}
HXLINE( 628)						{
HXLINE( 628)							 ::vision::ds::Array2D _this2 = result;
HXDLIN( 628)							_this2->inner->set((x + (y * _this2->width)),sum);
            						}
            					}
            				}
            			}
...
HXLINE( 645)								 ::vision::ds::Array2D _this = b;
HXDLIN( 645)								sum = (sum + (( (Float)(this1->inner->__get(((y * this1->width) + k))) ) * ( (Float)(_this->inner->__get(((k * _this->width) + x))) )));
            							}
            						}
HXLINE( 647)						{
HXLINE( 647)							 ::vision::ds::Array2D _this1 = result;
HXDLIN( 647)							_this1->inner->set((x + (y * _this1->width)),sum);
            						}
            					}
            				}
            			}
...
HXLINE( 661)						{
HXLINE( 661)							 ::vision::ds::Array2D _this = b;
HXDLIN( 661)							this1->inner->set((x + (y * this1->width)),(( (Float)(this1->inner->__get(((y * this1->width) + x))) ) + _this->inner->__get(((y * _this->width) + x))));
            						}
            					}
            				}
            			}
...
HXLINE( 676)						{
HXLINE( 676)							 ::vision::ds::Array2D _this = b;
HXDLIN( 676)							this1->inner->set((x + (y * this1->width)),(( (Float)(this1->inner->__get(((y * this1->width) + x))) ) - ( (Float)(_this->inner->__get(((y * _this->width) + x))) )));
            						}
            					}
            				}
            			}
...
HXLINE( 694)								 ::vision::ds::Array2D _this = b;
HXDLIN( 694)								sum = (sum + (( (Float)(this1->inner->__get(((y * this1->width) + k))) ) * ( (Float)(_this->inner->__get(((k * _this->width) + x))) )));
            							}
            						}
HXLINE( 696)						{
HXLINE( 696)							 ::vision::ds::Array2D _this1 = result;
HXDLIN( 696)							_this1->inner->set((x + (y * _this1->width)),sum);
            						}
            					}
            				}
            			}
