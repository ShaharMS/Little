...
HX_DEFINE_STACK_FRAME(_hx_pos_b2d9048aa5d956ac_278_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","/home/consonne/Téléchargements/haxe-manager/std/sys/thread/EventLoop.hx",278,0xf45c36fb)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_b2d9048aa5d956ac_278_new)
