...
HX_DEFINE_STACK_FRAME(_hx_pos_6bd67243a502204e_30_new,"sys.thread.Lock","new",0x586e3f40,"sys.thread.Lock.new","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/sys/thread/Lock.hx",30,0xab904b47)
HX_LOCAL_STACK_FRAME(_hx_pos_6bd67243a502204e_34_wait,"sys.thread.Lock","wait",0x0df8ef95,"sys.thread.Lock.wait","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/sys/thread/Lock.hx",34,0xab904b47)
namespace sys{
namespace thread{

void Lock_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6bd67243a502204e_30_new)
...
bool Lock_obj::wait( ::Dynamic __o_timeout){
            	...
            	HX_STACKFRAME(&_hx_pos_6bd67243a502204e_34_wait)
