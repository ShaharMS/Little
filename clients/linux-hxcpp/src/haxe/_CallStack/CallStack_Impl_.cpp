...
HX_LOCAL_STACK_FRAME(_hx_pos_8ee08db36526cbd2_71_toString,"haxe._CallStack.CallStack_Impl_","toString",0xaff80ceb,"haxe._CallStack.CallStack_Impl_.toString","/home/consonne/Téléchargements/haxe-manager/std/haxe/CallStack.hx",71,0x0f71c8b5)
static const ::String _hx_array_data_baffa80f_2[] = {
	HX_("\nCalled from ",bd,26,6b,81),
};
HX_LOCAL_STACK_FRAME(_hx_pos_8ee08db36526cbd2_84_subtract,"haxe._CallStack.CallStack_Impl_","subtract",0x6f9ab153,"haxe._CallStack.CallStack_Impl_.subtract","/home/consonne/Téléchargements/haxe-manager/std/haxe/CallStack.hx",84,0x0f71c8b5)
HX_LOCAL_STACK_FRAME(_hx_pos_8ee08db36526cbd2_120_equalItems,"haxe._CallStack.CallStack_Impl_","equalItems",0xbce5e9ab,"haxe._CallStack.CallStack_Impl_.equalItems","/home/consonne/Téléchargements/haxe-manager/std/haxe/CallStack.hx",120,0x0f71c8b5)
HX_LOCAL_STACK_FRAME(_hx_pos_8ee08db36526cbd2_156_itemToString,"haxe._CallStack.CallStack_Impl_","itemToString",0xddade49e,"haxe._CallStack.CallStack_Impl_.itemToString","/home/consonne/Téléchargements/haxe-manager/std/haxe/CallStack.hx",156,0x0f71c8b5)
...
::String CallStack_Impl__obj::toString(::Array< ::Dynamic> stack){
            	HX_GC_STACKFRAME(&_hx_pos_8ee08db36526cbd2_71_toString)
...
::Array< ::Dynamic> CallStack_Impl__obj::subtract(::Array< ::Dynamic> this1,::Array< ::Dynamic> stack){
            	HX_STACKFRAME(&_hx_pos_8ee08db36526cbd2_84_subtract)
...
bool CallStack_Impl__obj::equalItems( ::haxe::StackItem item1, ::haxe::StackItem item2){
            	HX_STACKFRAME(&_hx_pos_8ee08db36526cbd2_120_equalItems)
...
void CallStack_Impl__obj::itemToString( ::StringBuf b, ::haxe::StackItem s){
            	HX_STACKFRAME(&_hx_pos_8ee08db36526cbd2_156_itemToString)
...
HXLINE( 158)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_8,1);
            				}
            				else {
...
HXLINE( 160)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_9,1);
            						}
            						else {
...
HXLINE( 165)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_10,1);
            							}
            							else {
...
HXLINE( 168)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_11,1);
            						}
            						else {
...
HXLINE( 171)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_12,1);
            							}
            							else {
...
HXLINE( 175)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_13,1);
            						}
            						else {
...
HXLINE( 178)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_14,1);
            						}
            						else {
...
HXLINE( 181)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_15,1);
            						}
            						else {
