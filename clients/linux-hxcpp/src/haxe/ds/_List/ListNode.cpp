...
HX_DEFINE_STACK_FRAME(_hx_pos_ac0eaf37858bbfdd_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","/home/consonne/Téléchargements/haxe-manager/std/haxe/ds/List.hx",266,0x8b374661)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_ac0eaf37858bbfdd_266_new)
