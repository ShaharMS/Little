...
HX_DEFINE_STACK_FRAME(_hx_pos_6926be828d5c0108_12_new,"haxe.exceptions.ArgumentException","new",0x0586be82,"haxe.exceptions.ArgumentException.new","/home/consonne/Téléchargements/haxe-manager/std/haxe/exceptions/ArgumentException.hx",12,0xfd2d7936)
namespace haxe{
namespace exceptions{

void ArgumentException_obj::__construct(::String argument,::String message, ::haxe::Exception previous, ::Dynamic pos){
            	HX_STACKFRAME(&_hx_pos_6926be828d5c0108_12_new)
HXDLIN(  12)		{
