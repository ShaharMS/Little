...
HX_DEFINE_STACK_FRAME(_hx_pos_1a048903a2de235a_12_new,"haxe.exceptions.PosException","new",0x9ed038cf,"haxe.exceptions.PosException.new","/home/consonne/Téléchargements/haxe-manager/std/haxe/exceptions/PosException.hx",12,0xf1c2e079)
HX_LOCAL_STACK_FRAME(_hx_pos_1a048903a2de235a_25_toString,"haxe.exceptions.PosException","toString",0x179675dd,"haxe.exceptions.PosException.toString","/home/consonne/Téléchargements/haxe-manager/std/haxe/exceptions/PosException.hx",25,0xf1c2e079)
namespace haxe{
namespace exceptions{

void PosException_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic pos){
            	HX_STACKFRAME(&_hx_pos_1a048903a2de235a_12_new)
HXDLIN(  12)		{
...
::String PosException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_1a048903a2de235a_25_toString)
