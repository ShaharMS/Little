...
HX_DEFINE_STACK_FRAME(_hx_pos_ff858b424b3689aa_28_new,"EReg","new",0x8b859e81,"EReg.new","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/EReg.hx",28,0x9a1cb178)
HX_LOCAL_STACK_FRAME(_hx_pos_ff858b424b3689aa_36_match,"EReg","match",0x18fda1a6,"EReg.match","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/EReg.hx",36,0x9a1cb178)
HX_LOCAL_STACK_FRAME(_hx_pos_ff858b424b3689aa_45_matched,"EReg","matched",0x8ce62f85,"EReg.matched","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/EReg.hx",45,0x9a1cb178)
HX_LOCAL_STACK_FRAME(_hx_pos_ff858b424b3689aa_62_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/EReg.hx",62,0x9a1cb178)
HX_LOCAL_STACK_FRAME(_hx_pos_ff858b424b3689aa_74_split,"EReg","split",0x9749433b,"EReg.split","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/EReg.hx",74,0x9a1cb178)
HX_LOCAL_STACK_FRAME(_hx_pos_ff858b424b3689aa_98_replace,"EReg","replace",0xae923ad5,"EReg.replace","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/EReg.hx",98,0x9a1cb178)
...
void EReg_obj::__construct(::String r,::String opt){
            	HX_STACKFRAME(&_hx_pos_ff858b424b3689aa_28_new)
...
bool EReg_obj::match(::String s){
            	HX_STACKFRAME(&_hx_pos_ff858b424b3689aa_36_match)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_ff858b424b3689aa_45_matched)
...
HX_DEFINE_DYNAMIC_FUNC1(EReg_obj,matched,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACKFRAME(&_hx_pos_ff858b424b3689aa_62_matchedPos)
...
::Array< ::String > EReg_obj::split(::String s){
            	HX_STACKFRAME(&_hx_pos_ff858b424b3689aa_74_split)
HXLINE(  75)		int pos = 0;
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_ff858b424b3689aa_98_replace)
...
HXLINE( 124)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_2dda4a0f_9,1);
            							}
            							else {
...
HXLINE( 131)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_2dda4a0f_10,1);
            							}
            							else {
