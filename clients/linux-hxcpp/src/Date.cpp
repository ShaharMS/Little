...
HX_DEFINE_STACK_FRAME(_hx_pos_2422e6bb0ffb6156_26_new,"Date","new",0x9aa26240,"Date.new","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/Date.hx",26,0x1191ea99)
HX_LOCAL_STACK_FRAME(_hx_pos_2422e6bb0ffb6156_30_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/Date.hx",30,0x1191ea99)
HX_LOCAL_STACK_FRAME(_hx_pos_2422e6bb0ffb6156_105_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/Date.hx",105,0x1191ea99)
HX_LOCAL_STACK_FRAME(_hx_pos_2422e6bb0ffb6156_112_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","/home/consonne/Téléchargements/haxe-manager/std/cpp/_std/Date.hx",112,0x1191ea99)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_2422e6bb0ffb6156_26_new)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_2422e6bb0ffb6156_30_getTime)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,getTime,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_2422e6bb0ffb6156_105_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_2422e6bb0ffb6156_112_fromString)
