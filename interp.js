...
little_Little.run = function(code,debug) {
	...
	if(!little_tools_PrepareRun.prepared) {
		...
		little_tools_PrepareRun.addConditions();
		little_tools_PrepareRun.addProps();
		haxe_Log.trace(little_Little.operators.lhsOnly == null ? "null" : haxe_ds_StringMap.stringify(little_Little.operators.lhsOnly.h),{ fileName : "src/little/Little.hx", lineNumber : 90, className : "little.Little", methodName : "run"});
	}
	little_interpreter_Interpreter.interpret(little_parser_Parser.parse(little_lexer_Lexer.lex(code)),new little_interpreter_RunConfig(null,null,null,null,null));
	if(debug != null) {
		little_Little.debug = previous;
...
little_Keywords.defaultKeywordSet = new little_interpreter_KeywordConfig("define","action","as","return","nothing","true","false","Anything","Void","Number","Decimal","Boolean","Characters","Type","Sign","Main","Registered","print","error","read","run","Unknown",null,["++","--","**","+=","-=",">=","<=","==","&&","||","^^","!="],".","==","!=","^^","||","&&","from","to","jump");
